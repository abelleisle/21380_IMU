...
# FPU-related options.
ifeq ($(USE_FPU_OPT),)
  USE_FPU_OPT = -mfloat-abi=$(USE_FPU) -mfpu=$(ARCH_FPU)
endif
...
INCDIR = $(ARCH_CONFDIR) $(CONFDIR) $(ALLINC) $(TESTINC)
...
#RULESPATH = $(ARCH_RULESPATH)
include $(ARCH_RULESPATH)/arm-none-eabi.mk
include $(ARCH_RULESPATH)/rules.mk
